...
export const ui = {
  el: {
    ...
    'about.who.text1':
      'Στα ελληνικά, oikos σημαίνει σπίτι — και αυτό ακριβώς θελήσαμε να δημιουργήσουμε. Όχι απλά ένα εστιατόριο, αλλά έναν χώρο όπου νιώθεις άνετα από τον πρώτο σου καφέ μέχρι το τελευταίο cocktail.',
    'about.who.text2':
