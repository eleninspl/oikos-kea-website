...
const sushiTab: MenuTab = {
  ...
  sections: [
    ...
    },
    {
      ...
      titleEn: 'Donburi',
      items: [
        { nameEl: 'Chirashi', nameEn: 'Chirashi', price: '€16', descEl: 'Ρύζι, πίκλα ginger, τόνος, σολομός, hamachi, λαβράκι, shiso, αγγούρι, αβοκάντο, αυγά σολομού, chirashi dressing', descEn: 'Rice, pickled ginger, tuna, salmon, hamachi, sea bass, shiso, cucumber, avocado, salmon roe, chirashi dressing' },
      ],
    },
    {
      titleEl: 'Sushi Rolls',
      ...
      items: [
        ...
        { nameEl: 'Spicy Maguro (6 τεμ.)', nameEn: 'Spicy Maguro (6 pcs)', price: '€14', descEl: 'Μέσα: σουσάμι kimchi — Πάνω: ταρτάρ τόνου, φρέσκο κρεμμύδι, yuzu tobiko, takuan, μαγιονέζα chili yuzu, κόκκινο τσίλι', descEn: 'Inside: kimchi sesame — Top: tuna tartare, fresh onion, yuzu tobiko, takuan, chili yuzu mayo, red chili' },
        { nameEl: 'Hamachi Jalapeño (6 τεμ.)', nameEn: 'Hamachi Jalapeño (6 pcs)', price: '€18', descEl: 'Μέσα: αβοκάντο, μαγιονέζα τρούφας, φρέσκια τρούφα — Πάνω: ταρτάρ hamachi, takana, takuan, jalapeño dressing, μαύρο σκόρδο, λάδι κόκκινου τσίλι', descEn: 'Inside: avocado, truffle mayo, fresh truffle — Top: hamachi tartare, takana, takuan, jalapeño dressing, black garlic, chili oil' },
