...
> ⚠️ **Σημείωση (ιστορικό):** Η περιγραφή του μοντέλου δεδομένων παρακάτω αφορά
> ΠΑΛΙΟΤΕΡΗ έκδοση (5 καρτέλες, `subsection`, πεδίο `category.tabs/menus`, ~155
> προϊόντα). Το **τρέχον** μοντέλο είναι 7 καρτέλες, τα προϊόντα είναι ξεχωριστά
> `menuItem` documents, και η κατηγορία έχει ΕΝΑ `menu` reference. Πηγή αλήθειας
> είναι πλέον το ίδιο το Sanity. **Τα βήματα deploy/πρόσκλησης πιο κάτω ισχύουν.**
