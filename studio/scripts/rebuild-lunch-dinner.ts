...
const CATS: Cat[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        el: 'Κριθαρότο μανιταριών',
        en: 'Orzo with mushrooms',
        price: 15.5,
      ...
      {
        el: 'Rib-Eye Αμερικής 300gr',
        en: 'Rib-Eye USA 300gr',
        price: 37,
...
async function run() {
  ...
  console.log(
    `✓ Lunch/Dinner: ${CATS.length} κατηγορίες, ${n} προϊόντα (σβήστηκαν ${oldCats.length} cats / ${oldItems.length} items)`,
  );
}
run().catch((e) => {
  console.error(e);
