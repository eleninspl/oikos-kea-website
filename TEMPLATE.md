...
## 3) Εικόνες / βίντεο → `public/images/`

Κράτα **ίδια ονόματα αρχείων** για zero αλλαγές στον κώδικα (ή ενημέρωσε τις αναφορές).
Προτεινόμενες διαστάσεις = οι τρέχουσες:

| Αρχείο                              | Διαστάσεις  | Χρήση                                   |
| ----------------------------------- | ----------- | --------------------------------------- |
| `brand/logo-wordmark.png`           | 450×106     | Λογότυπο σε nav & footer (`<img>` 450×106) |
| `brand/logo.png`                    | 916×766     | Λογότυπο studio                          |
| `brand/og-image.jpg`                | 1206×1548   | Προεπιλεγμένη OG/Twitter εικόνα (δες `web.ogImage*`) |
| `brand/sign.jpg`                    | 1206×1548   | Φωτό «about strip» (αρχική & σελίδα Σχετικά) |
